    ...
    <style>
        * { font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        @keyframes blob {
            ...
            25%  { transform: translate3d(22px, -32px, 0) scale(1.08); }
            50%  { transform: translate3d(-18px, 22px, 0) scale(0.92); }
            75%  { transform: translate3d(28px, 8px, 0) scale(1.04); }
        }
        .animate-blob {
        ...
        /* ── Gradient border card (feature cards) ───── */
        .gradient-border {
            position: relative;
            background: white;
            border-radius: 24px;
...
<body class="antialiased bg-[#f8fffe] text-gray-900 overflow-x-hidden">
    ...
    <nav x-data="{ atTop: true, mobileOpen: false }"
        ...
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center gap-8">
                <a href="#fitur" class="nav-link text-sm font-semibold text-gray-600 hover:text-green-600 transition">Fitur</a>
                <a href="#cara-kerja" class="nav-link text-sm font-semibold text-gray-600 hover:text-green-600 transition">Cara Kerja</a>
                <a href="#statistik" class="nav-link text-sm font-semibold text-gray-600 hover:text-green-600 transition">Dampak</a>
                @auth
                    <a href="{{ url('/dashboard') }}" class="px-5 py-2.5 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-xl font-bold text-sm transition shadow-lg shadow-green-200/60 hover:-translate-y-0.5">
                        Buka Dashboard
                    </a>
                @else
                    <a href="{{ route('login') }}" class="text-sm font-bold text-gray-600 hover:text-green-600 transition">Masuk</a>
                    <a href="{{ route('register') }}" class="px-5 py-2.5 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-xl font-bold text-sm transition shadow-lg shadow-green-200/60 hover:-translate-y-0.5">
                        Daftar Gratis
                    </a>
                @endauth
            </div>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-16 relative z-10 py-20">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="animate__animated animate__fadeInLeft">
                    <div class="inline-flex items-center gap-2 px-4 py-2 hero-badge rounded-full mb-8">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 mb-12">
                        @auth
                            <a href="{{ url('/dashboard') }}"
                               class="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-2xl font-bold text-lg transition duration-300 shadow-2xl shadow-green-300/40 hover:-translate-y-1">
                        ...
                        @else
                            ...
                            <a href="#cara-kerja"
                               class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-gray-700 rounded-2xl font-bold text-lg hover:bg-green-50 hover:border-green-200 hover:text-green-700 transition duration-300 shadow-lg border border-gray-200">
    ...
    <section class="py-28 relative overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-emerald-700 via-green-700 to-teal-700"></div>
        <div class="absolute inset-0 cta-dots"></div>
        {{-- Decorative blobs --}}
        <div class="absolute top-0 left-0 w-72 h-72 bg-white/5 rounded-full filter blur-3xl"></div>
        <div class="absolute bottom-0 right-0 w-96 h-96 bg-teal-400/10 rounded-full filter blur-3xl"></div>

        <div class="max-w-4xl mx-auto px-6 text-center relative z-10 reveal">
            <div class="inline-flex items-center gap-2 px-5 py-2.5 bg-white/15 backdrop-blur border border-white/20 rounded-full text-white text-xs font-bold uppercase tracking-widest mb-8">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                Mulai Sekarang — 100% Gratis
            </div>
            <h2 class="text-4xl lg:text-6xl font-black text-white mb-6 leading-tight">
                Siap Jadi Bagian dari<br>
                <span class="text-emerald-200">Gerakan Hijau Indonesia?</span>
            </h2>
            <p class="text-green-100/90 text-lg lg:text-xl mb-12 max-w-2xl mx-auto leading-relaxed">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                @auth
                    <a href="{{ url('/dashboard') }}"
                       class="inline-flex items-center gap-3 px-10 py-5 bg-white text-green-700 rounded-2xl font-black text-lg hover:bg-emerald-50 hover:-translate-y-1 transition duration-300 shadow-2xl">
                ...
                @else
                    ...
                    <a href="{{ route('login') }}"
                       class="inline-flex items-center gap-3 px-10 py-5 bg-white/10 backdrop-blur text-white border-2 border-white/25 rounded-2xl font-black text-lg hover:bg-white/20 hover:-translate-y-1 transition duration-300">
                        Sudah Punya Akun
            ...
            <div class="grid md:grid-cols-4 gap-12 mb-12">
                <div class="md:col-span-2">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="#" class="social-btn w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center">
                            <svg class="w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 24 24"><path d="{{ $icon }}"/></svg>
                        </a>
                        @endforeach
                    </div>
                </div>
