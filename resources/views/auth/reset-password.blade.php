...
<head>
    ...
    <title>Reset Password — EcoDrop</title>
        ...
        <div class="relative z-10">
            <div class="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20 mb-8">
                ...
                <p class="text-green-100 text-sm leading-relaxed">
                    Pastikan password baru kamu kuat dan mudah diingat. Gunakan kombinasi huruf, angka, dan simbol.
                </p>
            </div>
            <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-5 border border-white/20">
                ...
                <ul class="space-y-2">
                    <li class="flex items-center gap-2 text-green-100 text-xs">
                        <span class="w-5 h-5 bg-green-400/30 rounded-full flex items-center justify-center text-xs">✓</span>
                        Minimal 8 karakter
                    </li>
                    <li class="flex items-center gap-2 text-green-100 text-xs">
                        <span class="w-5 h-5 bg-green-400/30 rounded-full flex items-center justify-center text-xs">✓</span>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div class="w-full max-w-md">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-500 text-sm">Masukkan password baru untuk akun EcoDrop kamu.</p>
            </div>

            <form method="POST" action="{{ route('password.store') }}" x-data="{ showPass: false, showConfirm: false }" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email"
                           ...
                           class="w-full px-4 py-3 rounded-xl border-2 {{ $errors->has('email') ? 'border-red-400 bg-red-50' : 'border-gray-200 bg-gray-100' }} focus:outline-none font-medium text-gray-700 cursor-not-allowed"
                           readonly>
                    @error('email')
