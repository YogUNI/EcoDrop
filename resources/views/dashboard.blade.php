<x-app-layout>
    ...
    <div x-data="{ isModalOpen: false }" class="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-blue-50 py-12 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 relative z-10">
            ...
            @if(Auth::user()->role === 'admin')
                    ...
                    <div class="group bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-gray-100/50 hover:shadow-xl transition duration-300 transform hover:scale-105 hover:-translate-y-1">
                        <div class="flex justify-between items-start mb-4">
                            <div>
                                ...
                                <h3 class="text-4xl font-black text-gray-900 mt-2">{{ $pickups->count() }}</h3>
                            </div>
                    ...
                    <div class="group bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-gray-100/50 hover:shadow-xl transition duration-300 transform hover:scale-105 hover:-translate-y-1">
                        <div class="flex justify-between items-start mb-4">
                            <div>
                                ...
                                <h3 class="text-4xl font-black text-yellow-600 mt-2">{{ $pickups->where('status', 'pending')->count() }}</h3>
                            </div>
                    ...
                    <div class="group bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-gray-100/50 hover:shadow-xl transition duration-300 transform hover:scale-105 hover:-translate-y-1">
                        <div class="flex justify-between items-start mb-4">
                            <div>
                                ...
                                <h3 class="text-4xl font-black text-green-600 mt-2">{{ $pickups->where('status', 'approved')->count() }}</h3>
                            </div>
                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-100/50 overflow-hidden">
                    <div class="p-8 border-b border-gray-100 bg-gradient-to-r from-green-50 to-emerald-50 flex justify-between items-center">
                        <div>
                            ...
                            <table class="w-full text-left">
                                ...
                                <tbody>
                                    @foreach($pickups as $pickup)
                                        <tr class="border-b border-gray-100 hover:bg-gradient-to-r hover:from-green-50 hover:to-transparent transition duration-300 group">
                                            <td class="py-5 pl-4">
                                                <div class="flex items-center gap-3">
                                            ...
                                            <td class="py-5">
                                                <div class="flex items-center gap-2">
                                                    <span class="inline-flex items-center gap-2 bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 py-2 px-4 rounded-full text-sm font-bold shadow-sm">
                                                        @if($pickup->type === 'Plastik') 🪴 @elseif($pickup->type === 'Kertas') 📄 @else ♻️ @endif
                                                        {{ $pickup->type }}
                                                    </span>
            ...
            @else
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                    ...
                    <div class="md:col-span-2 group bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-2xl border border-gray-100/50 hover:shadow-3xl transition duration-300 flex flex-col justify-between transform hover:scale-102 hover:-translate-y-1">
                        <div class="mb-6">
                            ...
                            <p class="text-gray-600 mt-2 font-medium">Ubah sampah plastik dan kertas Anda menjadi poin reward! Setiap setor adalah kontribusi untuk planet yang lebih hijau.</p>
                        </div>
                ...
                <div x-show="isModalOpen" 
                     ...
                     class="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/50 backdrop-blur-md">
                    ...
                    <div @click.away="isModalOpen = false" 
                         ...
                         x-transition:leave-start="opacity-100 transform scale-100"
                         x-transition:leave-end="opacity-0 transform scale-90"
                         class="bg-white rounded-3xl p-8 w-full max-w-lg shadow-2xl relative border border-gray-100 overflow-hidden">
                        ...
                        <form method="POST" action="{{ route('pickups.store') }}" class="space-y-5">
                            ...
                            <div>
                                ...
                                <input type="number" name="weight" step="0.1" required placeholder="Contoh: 5.5" class="w-full px-4 py-3 rounded-xl border-2 border-gray-300 focus:border-green-500 focus:outline-none focus:ring-4 focus:ring-green-200 transition duration-300 font-semibold bg-gray-50 focus:bg-white" />
                            ...
                            <div>
                                ...
                                <input type="date" name="pickup_date" required min="{{ date('Y-m-d') }}" class="w-full px-4 py-3 rounded-xl border-2 border-gray-300 focus:border-green-500 focus:outline-none focus:ring-4 focus:ring-green-200 transition duration-300 font-semibold bg-gray-50 focus:bg-white cursor-pointer" />
